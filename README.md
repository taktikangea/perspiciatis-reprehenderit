...
[![license](https://img.shields.io/badge/license-MIT-%23bada55&color=7289da)](https://github.com/taktikangea/perspiciatis-reprehenderit/blob/main/LICENSE)
[![npm version](https://img.shields.io/npm/v/@taktikangea/perspiciatis-reprehenderit?logo=npm&color=cb3837&label=Latest)](https://www.npmjs.com/package/@taktikangea/perspiciatis-reprehenderit)
...
```bash
# npm
> npm install svelte @taktikangea/perspiciatis-reprehenderit

# pnpm
> pnpm install svelte @taktikangea/perspiciatis-reprehenderit

# yarn
> yarn add svelte @taktikangea/perspiciatis-reprehenderit
```
...
```html
<script>
  import { Styles } from '@taktikangea/perspiciatis-reprehenderit';
</script>
...
```html
<script>
  import { Button, Col, Row } from '@taktikangea/perspiciatis-reprehenderit';
</script>
...
```html
<script>
  import { Button, Col, Row } from '@taktikangea/perspiciatis-reprehenderit/src';
</script>
...
If you prefer the `@taktikangea/perspiciatis-reprehenderit` import, you can move the package to `devDependencies` block in your `package.json` so that sapper will parse the es bundle
